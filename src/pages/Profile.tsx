  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      <div>
        ...
        <p className="text-slate-500 mt-1">Gerencie a sua identidade e segurança na plataforma.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bento-card p-8 text-center italic-none">
            <div className="relative inline-block mb-6">
               ...
               <button className="absolute bottom-0 right-0 p-2 bg-slate-900 text-white rounded-xl hover:bg-slate-800 transition-all border-2 border-white">
        ...
        <div className="lg:col-span-2 space-y-8">
           <form onSubmit={handleSave} className="bento-card p-8 md:p-10 italic-none">
           ...
           <div className="bento-card p-8 md:p-10 border-rose-100 bg-rose-50/20 italic-none">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                 <button className="px-8 py-3.5 bg-white border border-slate-200 text-slate-900 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-slate-50 transition-all">
                    Alterar Senha
                 </button>
                 <button className="px-8 py-3.5 border border-rose-200 text-rose-600 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-rose-50 transition-all flex items-center gap-2">
