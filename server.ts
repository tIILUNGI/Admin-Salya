...
async function startServer() {
  ...
  let plans = [
    { id: "p1", name: "Demo", price: 0, durationDays: 30, active: true, type: "DEMO", category: "GRATUITO", maxEntidades: 1, maxUtilizadores: 2 },
    { id: "p2", name: "Plano Doméstico", price: 57000, durationDays: 180, active: true, type: "SEMESTRAL", category: "PAGO", maxEntidades: 1, maxUtilizadores: 1 },
    { id: "p3", name: "Plano Profissional", price: 129960, durationDays: 365, active: true, type: "ANUAL", category: "PAGO", maxEntidades: 1, maxUtilizadores: 2 },
  ];
